...
namespace ch_nhac_cu.Areas.admin.Controllers
{
    public class BillsController : Controller
    {
        ...
        //[HttpPost]
        //[ValidateAntiForgeryToken]
        //public ActionResult Edit([Bind(Include = "NgayGH,TinhTrangDonHang")] HoaDon hoaDon)
        //{
        //    if (ModelState.IsValid)
        //    {
        ...
        //            db.Entry(existingHoaDon).State = EntityState.Modified;
        //            db.SaveChanges();
        //        }
        //        return RedirectToAction("Index");
        //    }
        ...
        //[HttpPost]
        //[ValidateAntiForgeryToken]
        //public ActionResult EditTinhTrangGiaoHang(HoaDon hoaDon)
        //{
        //    if (ModelState.IsValid)
        //    {
        //        // Retrieve the existing HoaDon from the database
